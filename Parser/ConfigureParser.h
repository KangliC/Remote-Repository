...
public:
  ...
  Parser* Build();
  void configRepos(Repository* pR, std::string file) {
	  pRepo = pR;
	  pRepo->setFile(file);
  }
private:
  ...
  SpecialKeyWordsDefinition2* pSpecialKeyWordsDefinition2;
  ValuelistDefinition* pValuelistDefinition;
  ...
  PushSpecialKeyWord2* pPushSpecialKeyWord2;
  PushValuelist* pPushValuelist;
