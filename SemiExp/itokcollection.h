...
/*
  ...
  Maintenance History:
  ====================
  ver 1.3 : 05 April 2016
  - add findFromBack() method
  ver 1.2 : 15 Feb 2016
...
struct ITokCollection
{
  ...
  virtual size_t findFromBack(const std::string& tok) = 0;
  virtual size_t findFrom(size_t pos, const std::string& tok) = 0;
